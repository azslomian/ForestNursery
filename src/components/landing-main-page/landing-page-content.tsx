          ...
          <div className="md:flex md:flex-wrap">
            ...
            <div className="md:w-1/2 relative">
              <div className="hidden md:block">
                ...
                >
                  <div
                    className="bg-green-800 mx-auto rounded-lg px-2 pb-2 relative mb-8"
                  >
                    <div className="mb-1">
                      <span
                        className="w-1 h-1 bg-green-100 rounded-full inline-block"
                      ></span
                      ><span
                        className="w-1 h-1 bg-green-100 rounded-full inline-block"
                      ></span
                    ...
                    <div className="h-1 w-12 bg-green-100 rounded mb-1"></div>
                    <div className="h-1 w-10 bg-green-100 rounded mb-2"></div>

                    <div className="flex">
                      <div className="w-6 h-3 rounded bg-green-100 mr-1"></div>
                      <div className="w-6 h-3 rounded bg-green-100"></div>
                    </div>
                ...
                >
                  <div
                    className="bg-green-800 mx-auto rounded-lg relative mb-8 py-2 w-20 border-2 border-white"
                  >
                    <div
                    ...
                    <div
                      className="flex items-center justify-center h-6 bg-green-800 w-6 rounded-l-lg ml-auto border-4 border-white -mr-1"
                    >
                      <div
                        className="h-2 w-2 rounded-full bg-green-800 border-2 border-white"
                      ></div>
                    </div>
                ...
                >
                  <div
                    className="bg-green-800 mx-auto rounded-lg pt-4 mb-16 relative"
                  >
                    ...
                    <div className="text-right my-2 pb-1">
                      ...
                      ></div>
                      <div
                        className="inline-flex w-3 h-3 rounded-full bg-green-800 border-2 border-white mr-2"
                      ></div>
                    </div>
              ...
              >
                <div
                  className="bg-green-800 mx-auto rounded-lg w-20 pt-3 mb-12 relative"
                >
